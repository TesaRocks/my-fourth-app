...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signup = function (email, password) {
        var _this = this;
        return this.http
            .post('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDRoHmViLfUhx-4JTKPvNRR0uemq2wCCpk', { email: email, password: password, returnSecureToken: true })
    ...
    AuthService.prototype.login = function (email, password) {
        var _this = this;
        return this.http
            .post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key= AIzaSyDRoHmViLfUhx-4JTKPvNRR0uemq2wCCpk', { email: email, password: password, returnSecureToken: true })
            .pipe(operators_1.catchError(this.handleError), operators_1.tap(function (resData) {
            _this.handleAuthentication(resData.email, resData.localId, resData.idToken, +resData.expiresIn);
        }));
    };
